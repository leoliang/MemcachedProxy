 ...
 * 
 */
public class DefaultMStubServer implements MStubServer {

    private static Logger              log     = Logger.getLogger(DefaultMStubServer.class);
    ...
    public DefaultMStubServer(ServerSocketChannelFactory channelFactory, ChannelGroup allChannels,
